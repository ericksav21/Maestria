...
-Un string. El nombre del método a ejecutar: rosembrock_2, rosembrock_n, wood, smoothing.
...
-Un string. Tipo de cálculo de alfa: StepHess, StepAprox, StepFijo.
-Un flotante. El tamaño de paso alfa fijo (Sólo si en el parámetro anterior se indicó: StepFijo).

Ejemplo de ejecución: ./main rosembrock_2.txt rosembrock_2 1000000 1e-5 1e-3 1e-7 StepHess
...
*Se incluyen las gráficas generadas para las funciones 1 y 4.
