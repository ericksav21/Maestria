...
*El programa aplicará el método de Newton para el punto inicial indicado. En cada iteración se imprimirán los valores: k, x_k, ||F(x_k)|| y k(J(x_k)). Al final terminar el algoritmo se imprimirá la razón de término: Número de iteraciones alcanzadas, tolerancia alcanzada, errores, etc.
