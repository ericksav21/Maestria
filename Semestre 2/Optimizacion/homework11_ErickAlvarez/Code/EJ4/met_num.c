...
void LM(double *x0, double *d_x, double *d_y, int n, int m, void (*f_ptr)(double*, double*, double*, double*, int, int),
		void (*J_ptr)(double*, double*, double*, double**, int, int, double), double v, int iter_max, double tol,
		double h) {
